...
const MoreInfo: React.FC = () => {
    return (
        <section id="moreinfo" className="py-20">
            <div className="container mx-auto px-6">
                ...
                <div className="space-y-12 max-w-4xl mx-auto">
                    <div className="p-8 bg-gray-900 rounded-2xl shadow-xl border border-gray-800 transition-all duration-300 hover:border-violet-700 hover:shadow-2xl hover:shadow-violet-500/10">
                        <h3 className="text-2xl font-bold text-violet-400 mb-4">1. Registration Procedure</h3>
                    ...
                    <div className="p-8 bg-gray-900 rounded-2xl shadow-xl border border-gray-800 transition-all duration-300 hover:border-violet-700 hover:shadow-2xl hover:shadow-violet-500/10">
                        <h3 className="text-2xl font-bold text-violet-400 mb-4">2. Communication</h3>
                        <div className="text-gray-400 space-y-2">
                            ...
                            Devika : <a href="tel:8138950611" className="hover:text-violet-300">8138950611</a><br/>
                            Ashwin : <a href="tel:7736011978" className="hover:text-violet-300">7736011978</a></p>
                        </div>
                    </div>

                    <div className="p-8 bg-gray-900 rounded-2xl shadow-xl border border-gray-800 transition-all duration-300 hover:border-violet-700 hover:shadow-2xl hover:shadow-violet-500/10">
                        <h3 className="text-2xl font-bold text-violet-400 mb-4">3. Transport</h3>
                        <div className="text-gray-400 space-y-2">
                    ...
                    <div className="p-8 bg-gray-900 rounded-2xl shadow-xl border border-gray-800 transition-all duration-300 hover:border-violet-700 hover:shadow-2xl hover:shadow-violet-500/10">
                        <h3 className="text-2xl font-bold text-violet-400 mb-4">4. General</h3>
                ...
                <div className="text-center mt-16 p-6 bg-gray-900/50 rounded-2xl max-w-2xl mx-auto border border-violet-800/50">
                    <h3 className="text-2xl font-bold text-violet-400">Deadline</h3>
                    <p className="text-gray-300 mt-2 text-lg">Registrations will close by 23rd September 2025.</p>
                </div>
            </div>
        </section>
    );
